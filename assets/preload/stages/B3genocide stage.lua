function onCreate()
   ...
   makeLuaSprite('tabi_genocide_stage','b3_genocide_stage',-500,-300);
   ...
   makeAnimatedLuaSprite('sexualintercourse5', 'B3_PostExpGF_Assets', 850,400);
   addAnimationByPrefix('sexualintercourse5', 'first', 'GF LayedDownHurt', 24, true);
